export const site = {
  ...
  url: "https://www.zaautomation.com",
  ...
  brands: ["ABI", "Bauer", "Liebherr", "SANY", "Casagrande", "Antares", "RTG", "Soilmec"],
...
export const services = [
  {
    ...
    short: "Logic development, retrofit and commissioning for industrial controllers on foundation equipment.",
    description:
  ...
  },
  {
    ...
    short: "Custom operator interfaces for monitoring, alarms and machine parameter control.",
    description:
  ...
  },
  {
    ...
    short: "Bus analysis, node isolation, joystick integration and communication recovery.",
    description:
  ...
  },
  {
    ...
    short: "Angle, pressure, load and proximity sensors set to required tolerances.",
    description:
  ...
  },
  {
    ...
    short: "Harness tracing, power integrity and intermittent electrical fault isolation.",
    description:
  ...
  },
  {
    ...
    short: "Control stick integration and mapping for modern foundation machinery.",
    description:
  ...
  },
  {
    ...
    short: "Panel solutions, wiring harness repair and industrial loom recovery.",
    description:
...
export const machines = [
  ...
  {
    id: "rotary",
    image: "/assets/images/drilling-rig.jpeg",
    brand: "SANY / Rotary",
    tag: "Drilling",
  ...
  {
    id: "vibro",
    image: "/assets/images/vibro-hammer.jpeg",
    brand: "Antares / Vibro",
    tag: "Vibro",
...
export function waLink(text = "Hello ZA Automation, I need automation support for my machinery.") {
