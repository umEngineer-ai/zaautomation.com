...
export const metadata = {
  title: {
    absolute: "ZA Automation Dubai | PLC, HMI & CANbus for Piling & Foundation Machinery",
  },
  description:
  ...
  return (
    <SiteChrome>
        ...
        <div className="hero__content">
          <div>
            ...
            <p className="hero__lead">
              ZA Automation Technical Services LLC keeps ABI, Bauer, Liebherr and rotary fleets
              productive with specialist PLC, HMI, CANbus and electrical diagnostics — delivered on
              site from Dubai across the UAE.
            </p>
      ...
      <section className="marquee" aria-label="Supported machinery brands">
        <div className="marquee__label">Trusted across major foundation platforms</div>
        ...
        <div className="container about">
          ...
          <div className="about__copy">
            ...
            <p className="reveal reveal-d2">
              ZA Automation Technical Services LLC delivers automation, troubleshooting and control
              solutions for piling and foundation machinery. From our Dubai office in Al Barah, we
              support contractors across the UAE with disciplined field diagnostics.
            </p>
            <p className="reveal reveal-d3">
              From the first fault code to verified handback, our engineers work as an extension of
              your maintenance team — protecting schedules when downtime is not an option.
            </p>
        ...
        <div className="container">
          <div className="section__head">
            <div className="section__head-copy">
              ...
              <p className="reveal reveal-d2">
                Core services for foundation contractors — controls, diagnostics, sensor calibration,
                electrical fault finding and on-site recovery.
              </p>
            </div>
          ...
          <div className="bento">
            <article className="service-card service-card--lg reveal">
              ...
              <p>
                Logic development, retrofit and commissioning for industrial controllers — plus
                operator interfaces that make alarms, parameters and machine status clear under real
                site conditions.
              </p>
            ...
            <div className="service-card service-card--md">
              <article className="service-card service-card--nested reveal reveal-d2">
                ...
                <p>Bus analysis, node isolation, joystick integration and communication recovery.</p>
              ...
              <article className="service-card service-card--nested reveal reveal-d3">
                ...
                <p>Load moment indicators, boom angle sensors and safe-load calibration.</p>
            ...
            {homeServices.slice(3).map((svc, idx) => (
              ...
              >
                ...
                <h3>{svc.title}</h3>
                <p>{svc.short}</p>
                <Link className="service-card__link" href={`/services#${svc.id}`}>
                  Get support
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2">
                    <path d="M5 12h14M13 5l7 7-7 7" />
                  </svg>
        ...
        <div className="container">
          <div className="section__head">
            <div className="section__head-copy">
              ...
              <p className="reveal reveal-d2">
                Deep hands-on experience with the heavy plant behind piling, drilling and
          ...
          <div className="machine-grid">
            {machines.map((m, i) => (
              <Link
                ...
                key={m.id}
              >
                <Image src={m.image} alt={m.title} fill sizes="400px" style={{ objectFit: "cover" }} />
                <div className="machine-card__shade" />
                <div className="machine-card__body">
                  <span className="machine-card__tag">{m.tag}</span>
                  <h3>{m.title.replace(" Sheet Pile Machines", " Machines").replace(" Drilling Equipment", " Rigs").replace(" & Systems", "")}</h3>
                  <p>{m.description}</p>
                </div>
              </Link>
            ))}
        ...
        <div className="container">
          <div className="section__head">
            <div className="section__head-copy">
              ...
              <h2 className="reveal reveal-d1">A clear path from fault call to handback</h2>
              <p className="reveal reveal-d2">
                Predictable engagement for maintenance managers and project directors who need
          ...
          <div className="process-grid">
            {[
              ["01", "Briefing", "Machine model, codes, history and site constraints captured before mobilization."],
              ["02", "Diagnosis", "Structured scan of power, PLC, CANbus, sensors and safety circuits on site."],
              ["03", "Intervention", "Repair, reprogram, calibrate or replace — with root cause addressed, not masked."],
              ["04", "Verification", "Functional proving and a clear service record for your maintenance file."],
            ].map(([n, t, p], i) => (
              <article className={`process-card reveal${i ? ` reveal-d${i + 1}` : ""}`} key={n}>
        ...
        <div className="container">
          <div className="section__head">
            <div className="section__head-copy">
              ...
              <h2 className="reveal reveal-d1">Uptime is the only metric that matters on site</h2>
            </div>
          </div>
          <div className="proof">
            <article className="proof__main reveal">
              ...
              <div className="proof__main-content">
                ...
                <p>
                  When a rig stops, every hour counts. We isolate control-system faults with
                  OEM-grade discipline so your fleet returns to production with confidence.
                </p>
                <Link className="btn btn--accent" href="/contact">
                  Schedule support
                </Link>
            ...
            <div className="proof__side">
              <article className="proof-card reveal reveal-d2">
                ...
                <p>From rapid fault calls to planned automation upgrades across foundation fleets.</p>
              </article>
              <article className="proof-card reveal reveal-d3">
                <strong>{site.stats.installs}</strong>
                <h4>Major installations</h4>
                <p>Commissioning, integration and calibration work on critical site equipment.</p>
              </article>
              <article className="proof-card reveal reveal-d4">
                <strong>{site.stats.coverage}</strong>
                <h4>Nationwide coverage</h4>
                <p>On-site engineers ready to support piling and drilling operations across the Emirates.</p>
              </article>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          <div className="section__head">
            <div className="section__head-copy">
              ...
              <h2 className="reveal reveal-d1">Trusted by teams who run foundation plant</h2>
            </div>
          </div>
          <div className="quotes">
            {testimonials.map((t, i) => (
              <article className={`quote-card reveal${i ? ` reveal-d${i + 1}` : ""}`} key={t.name}>
      ...
      <section className="section section--white">
        <div className="container">
          <CtaBand
            ...
            secondary={{
              href: waLink("Hello ZA Automation, I need urgent automation support."),
        ...
        <div className="container">
          <div className="section__head">
            <div className="section__head-copy">
              ...
              <p className="reveal reveal-d2">
                Tell us the machine and the fault. Reach us on WhatsApp {site.phoneDisplay} or email{" "}
                {site.email}.
              </p>
            </div>
          </div>
          ...
          <div className="contact">
            <aside className="contact__info reveal">
              ...
              <p>
                ZA Automation Technical Services LLC — specialist PLC, HMI, CANbus and electrical
                support for piling and foundation machinery.
              </p>
